...
$(document).ready(function () {
	...
	for ($(".promo_box").each(function () {
			...
			$(this).removeAttr("height");
		}), $("#pages_total").text(pages_amount), -1 !== location.href.indexOf("#") ? ($("#pg" + location.hash.replace("#", "")).show(), $("#pageof").val(propernumber)) : ($("#pg0").delay(600).show(), location.hash = "0", $("#pageof").val("1")), 1 === show_additional_menu && $("#submenu").show(), $(".fsi").each(function () {
