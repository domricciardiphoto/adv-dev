...
var tv_select =
    ...
    pages_amount = getElementByClassName('fsi').length,
    pg1 = 0,
    menu_length = getElementByClassName('submenu_button').length,
    swipeinfo = 0,
...
var nu = 0,
    urlname = "",
    urlname2 = "",
    lastpage = getElementByClassName('fsi').length - 1;
$(document).ready(function () {
    ...
    "" != window.location.hash ? ($("#pg" + location.hash.replace("#", "")).not("finished").html(eval(
       ...
       <div id = "intro" >sdfkghksldfhgjksdfhgskldfhglksdfg </div>
        )
        ...
        $("#pg0").addClass("finished"), $(".promo_box").each(function () {
            $(this).attr("id", "p" + nu), $(this).append('<div class="dynamic"></div>'), nu++
