...
<li>An elegant dinner reception at the Long Island Aquarium, where the walls are alive with gorgeous tropical fish tanks and after dinner cocktails and cigars on the edge of the Historic Peconic River.</li>
...
<li>Exclusive Premium P.C. Richard Foundation Gift bags.</li>
...
function outputDates($name, $value1, $value2){
    ...
    echo <<<OUTPUT
     <tr>
      <td colspan=2><input type=checkbox name="$nameDay1" $checked1 value="Y" title="Monday, October 7">&nbsp;Monday, October 7&nbsp;&nbsp;<input type=checkbox name="$nameDay2" $checked2 value="Y" title="Tuesday, October 8">&nbsp;Tuesday, October 8</td>
     </tr>
OUTPUT;
}
